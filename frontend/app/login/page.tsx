      ...
      <div className="w-full max-w-md">
        <div className="border rounded-lg p-8" style={{ borderColor: 'var(--line)', background: 'var(--panel)' }}>
          <div className="text-center mb-8">
            <div className="w-12 h-12 rounded flex items-center justify-center bg-gradient-emerald mx-auto mb-4">
            ...
            <p className="text-sm" style={{ color: 'var(--muted)' }}>WebChat Sales Dashboard</p>
          </div>
